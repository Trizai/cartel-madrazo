    ...
    (n = function(n, e) {
        ...
        var r = function() {
                return (
                    ...
                    t(i).on("resize", function() {
                        setTimeout(function() {
                            ...
                            i.css({ width: s.width, left: s.width }),
                                s.css.containers(),
                                s.css.images();
                        }, 10);
                    }),
                    s.options.hashchange &&
            ...
            h = {
                containers: function() {
                    s.init ?
                        (s.$el.css({ height: s.height }),
                            s.$control.css({ width: s.width * a, left: -s.width }),
                            s.$container.css({})) :
                        (t("body").css({ margin: 0 }),
                            s.$el.css({
                                position: "relative",
                    ...
                    i
                        ...
                        i.each(function() {
                            ...
                            if (t.data(this, "processed"))
                                s.image._scale(n, i), s.image._center(n, i);
                            else {
                                var e = new Image();
                                (e.onload = function() {
                                    s.image._scale(n, i),
                ...
                children: function() {
                    ...
                    i.is("img") &&
                        ...
                        s.init || i.css({ display: "none", left: 2 * s.width }),
                        i.css({
                            position: "absolute",
                            overflow: "hidden",
                            height: "100%",
            ...
            c = {
                slide: function(i, t) {
                    ...
                    e.css({ left: i.upcoming_position, display: "block" }),
                        s.$control.animate({ left: i.offset },
                            s.options.animation_speed,
                            s.options.animation_easing,
                            function() {
                                s.size() > 1 &&
                                    (s.$control.css({ left: -s.width }),
                                        n.eq(i.upcoming_slide).css({ left: s.width, zIndex: 2 }),
                                        i.outgoing_slide >= 0 &&
                                        n
                                        .eq(i.outgoing_slide)
                                        .css({ left: s.width, display: "none", zIndex: 0 })),
                                    t();
                            }
                        );
                },
                fade: function(i, t) {
                    ...
                    o
                        ...
                        s.animate({ opacity: 0 },
                            ...
                            function() {
                                n.size() > 1 &&
                                    (e.eq(i.upcoming_slide).css({ zIndex: 2 }),
                                        i.outgoing_slide >= 0 &&
                                        e
                                        .eq(i.outgoing_slide)
        ...
        var d = {
                ...
                _scale: function(i, n) {
                    ...
                    var e = s.height / s.width,
                        o = t(i);
                    e > n ?
                        o.css({ height: s.height, width: s.height / n }) :
                        o.css({ height: s.width * n, width: s.width });
                },
            },
            l = {
                ...
                _events: function() {
                    s.$el.on("click", s.options.elements.pagination + " a", function(i) {
                        ...
                        (t = s._upcomingSlide(n, !0)),
                        t !== s.current &&
                            s.animate(t, function() {
                                s.start();
                            });
                    });
                },
        ...
        return (
            this.each(function() {
                ...
                return (
                    ...
                    "string" == typeof i && ((o = r[i]), "function" == typeof o) ?
                    (o = o.call(r, s)) :
                    void 0
                );
            }),
